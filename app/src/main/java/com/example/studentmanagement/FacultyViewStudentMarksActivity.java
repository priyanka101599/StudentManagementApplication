...
public class FacultyViewStudentMarksActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_view_student_marks);
            ...
            cref.child(course).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        sp.setAdapter(adp);
                        sp.setOnItemSelectedListener(FacultyViewStudentMarksActivity.this);
                    }
                }
