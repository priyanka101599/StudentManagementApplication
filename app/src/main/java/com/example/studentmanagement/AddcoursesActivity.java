...
public class AddcoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timedialog = new TimePickerDialog(AddcoursesActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        addbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String coursedata = addcourse.getText().toString().toUpperCase().trim();
                String facdata = facname.getText().toString().toUpperCase().trim();
                String datedata = startdate.getText().toString().toUpperCase().trim();
                String durdata = coursedur.getText().toString().toUpperCase().trim();
                String startdata = startime.getText().toString().toUpperCase().trim();
                String enddata = endtime.getText().toString().toUpperCase().trim();
                if(coursedata.isEmpty()) {
                    ...
                    if(cref.child(coursedata) !=null) {
                        cref.child(coursedata).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    if ((coursedata.toUpperCase()).equalsIgnoreCase(cr.getCourse())) {
                                        if(count==1)
                                            Toast.makeText(AddcoursesActivity.this, "Course already added!", Toast.LENGTH_SHORT).show();
                                        else
                                            Toast.makeText(AddcoursesActivity.this, "Course added!", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    count = 0;
                                    Toast.makeText(AddcoursesActivity.this, "Course not found in the list", Toast.LENGTH_SHORT).show();
                                }
                            }
                        ...
                        if (count == 0) {
                            ...
                            Toast.makeText(AddcoursesActivity.this, "Course added!", Toast.LENGTH_SHORT).show();
                            //startActivity(new Intent(AddcoursesActivity.this, AdmincourseslistActivity.class));
                        }
    ...
    public void onBackPressed(){
        startActivity(new Intent(AddcoursesActivity.this,AdminHomeActivity.class));
    }
}
