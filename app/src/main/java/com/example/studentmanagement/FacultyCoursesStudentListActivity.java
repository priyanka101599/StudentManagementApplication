...
public class FacultyCoursesStudentListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_courses_student_list);
        ...
        layout_Manager = new LinearLayoutManager(FacultyCoursesStudentListActivity.this);
            ...
            protected void onBindViewHolder(@NonNull FacultyCourseStudentListViewHolder facultyCourseStudentListViewHolder, int i, @NonNull final StudentwithRegisteredcourses studentwithRegisteredcourses) {
                ...
                facultyCourseStudentListViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent=new Intent(FacultyCoursesStudentListActivity.this,FacultyAddedStudentAttendanceActivity.class);
