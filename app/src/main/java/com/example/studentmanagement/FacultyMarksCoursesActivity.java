...
public class FacultyMarksCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_marks_courses);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.exists()) {
                        if(faccid.equalsIgnoreCase(fac.getFacid())) {
                            ...
                            layout_Manager = new LinearLayoutManager(FacultyMarksCoursesActivity.this);
                                ...
                                protected void onBindViewHolder(@NonNull final FacultyCourseViewHolder facultyCourseViewHolder, int i, @NonNull final FacultyCourses facultyCourses) {
                                    ...
                                    facultyCourseViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            Intent in=new Intent(FacultyMarksCoursesActivity.this,FacultyMarksCoursesStudentListActivity.class);
